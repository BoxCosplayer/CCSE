// This page allows all users to view their profile and edit details
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-8">
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-lg bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                {/* Password */}
                <div className="mb-4">
                    <label htmlFor="password" className="block text-gray-700 font-medium mb-2">New Password (leave blank to prevent from changing)</label>
