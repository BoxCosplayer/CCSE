// This page displays all electronics items
...
export default function ElectronicsPage() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await fetch("/api/get-products?category=Electronics");
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-8 bg-black text-white">
            {/* Page Title */}
            <h1 className="text-4xl font-bold mb-6 text-center">Electronics Products</h1>
