// This page displays all Home & Living Items
...
export default function HomePage() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await fetch("/api/get-products?category=Home");
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-8 bg-black text-white">
            {/* Page Title */}
            <h1 className="text-4xl font-bold mb-6 text-center">Home & Living Products</h1>
